...
import {
    Box, Button, Dialog, DialogActions, DialogContent, DialogTitle, Grid, Modal, TextField, Typography,
} from "@mui/material";
...
const UpdateProfile = React.memo(({profile, updateMyProfile}) => {
    ...
    const formik = useFormik({
        initialValues: {fullName: profile.fullName, name: profile.name, phoneNumber: profile.contacts ? profile.contacts.phoneNumber : ''},
        onSubmit: values => {
            const data = {
